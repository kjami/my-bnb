...
import { FaBed, FaBath, FaRulerCombined, FaDollarSign, FaMap } from "react-icons/fa"

const FeaturedPropertyCard = ({ property }) => {
    const getRateDisplay = () => {
        if (property.rates.monthly) return `$${property.rates.monthly}/mo`;
        if (property.rates.weekly) return `$${property.rates.weekly}/wk`;
        if (property.rates.nightly) return `$${property.rates.nightly}/night`;
        return "NA";
    };
    return (<div
    ...
    <div className="p-6">
        ...
        >
            {property.rates.nightly && (<p><FaDollarSign className="inline-block mr-2" /> Nightly</p>)}
            {property.rates.weekly && (<p><FaDollarSign className="inline-block mr-2" /> Weekly</p>)}
            {property.rates.monthly && (<p><FaDollarSign className="inline-block mr-2" /> Monthly</p>)}
        </div>
